      ...
      <div className="ai-section">
        <div className="ai-container">
          <div className="ai-content">
            ...
            <p>
              Your Strategic Partner in Aligning Organizational Goals with Powerful IT Solutions. <br className="desktop-only" />
              We Empowering Tomorrow with Intelligent Solutions. Explore the Boundless Horizons <br className="desktop-only" />
